...
openprobs = []
open_probs = open("/Users/JackOHara/Desktop/code/Pythonprograms/Poker/probs/pokeropen.csv", 'r')
for x in open_probs:
    x = x[:len(x)-2]
    x = x.split(",")
    z = []
...
flop_probs = open("/Users/JackOHara/Desktop/code/Pythonprograms/Poker/probs/pokerflop1.csv", 'r')
...
turn_probs = open("/Users/JackOHara/Desktop/code/Pythonprograms/Poker/probs/pokerturn.csv", 'r')
...
river_probs = open("/Users/JackOHara/Desktop/code/Pythonprograms/Poker/probs/pokerriver.csv", 'r')
...
com_river = open("/Users/JackOHara/Desktop/code/Pythonprograms/Poker/probs/comriver1.csv", 'r')
...
com_turn = open("/Users/JackOHara/Desktop/code/Pythonprograms/Poker/probs/comturn1.csv", 'r')
